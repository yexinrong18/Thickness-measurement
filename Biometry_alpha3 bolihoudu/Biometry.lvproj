...
<Project Type="Project" LVVersion="15008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Sub VIs" Type="Folder">
			<Item Name="Boimetry Processing.lvlib" Type="Library" URL="../Sub VIs/Boimetry Processing/Boimetry Processing.lvlib"/>
			<Item Name="CCD.lvlib" Type="Library" URL="../Sub VIs/CCD/CCD.lvlib"/>
			<Item Name="DAQ.lvlib" Type="Library" URL="../Sub VIs/DAQ/DAQ.lvlib"/>
			<Item Name="Database Processing.lvlib" Type="Library" URL="../Sub VIs/Database Processing/Database Processing.lvlib"/>
			<Item Name="Digital Image Processing.lvlib" Type="Library" URL="../Sub VIs/Digital Image Processing/Digital Image Processing.lvlib"/>
			<Item Name="Digital Signal Processing.lvlib" Type="Library" URL="../Sub VIs/Digital Signal Processing/Digital Signal Processing.lvlib"/>
			<Item Name="IOL Processing.lvlib" Type="Library" URL="../Sub VIs/IOL Processing/IOL Processing.lvlib"/>
			<Item Name="Printer Processing.lvlib" Type="Library" URL="../Sub VIs/Printer Processing/Printer Processing.lvlib"/>
			<Item Name="Serial.lvlib" Type="Library" URL="../Sub VIs/Serial/Serial.lvlib"/>
			<Item Name="Utility VIs.lvlib" Type="Library" URL="../Sub VIs/Utility VIs/Utility VIs.lvlib"/>
		</Item>
		...
		<Item Name="Browse.lvlib" Type="Library" URL="../Browse/Browse.lvlib"/>
		...
		<Item Name="test程序完成后删掉.vi" Type="VI" URL="../test程序完成后删掉.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Biometry.ctl" Type="VI" URL="../Sub VIs/Database Processing/Support/Table/Biometry.ctl"/>
			<Item Name="Calculate And Update Ascan.vi" Type="VI" URL="../Sub VIs/Boimetry Processing/Calculate And Update Ascan.vi"/>
			<Item Name="Hardware Configuration.ctl" Type="VI" URL="../Acquisition/Hardware Configuration.ctl"/>
			<Item Name="Hardware Configuration.ctl" Type="VI" URL="../Action/Hardware Configuration.ctl"/>
			<Item Name="Insert Measure.vi" Type="VI" URL="../Sub VIs/Database Processing/Insert Measure.vi"/>
			...
			<Item Name="PLC动作指令集.ctl" Type="VI" URL="../PLC/PLC动作指令集.ctl"/>
			<Item Name="PLC控制指令.ctl" Type="VI" URL="../Action/PLC控制/PLC控制指令.ctl"/>
			<Item Name="PLC设置.ctl" Type="VI" URL="../Action/PLC控制/PLC设置.ctl"/>
			<Item Name="read work position.vi" Type="VI" URL="../Sub VIs/Boimetry Processing/read work position.vi"/>
			<Item Name="USB9825.dll" Type="Document" URL="../Sub VIs/DAQ/USB9825.dll"/>
			<Item Name="电机控制设置.ctl" Type="VI" URL="../Action/电机控制/电机控制设置.ctl"/>
			<Item Name="电机转动逻辑1.ctl" Type="VI" URL="../Action/电机控制/Motor Logic/电机转动逻辑1.ctl"/>
			<Item Name="动作设置.ctl" Type="VI" URL="../Action/动作设置.ctl"/>
			<Item Name="反转判断条件1.ctl" Type="VI" URL="../Action/电机控制/Motor Logic/反转判断条件1.ctl"/>
			<Item Name="其他动作设置 .ctl" Type="VI" URL="../Action/其他动作设置 .ctl"/>
			<Item Name="所有测试电机转动逻辑.ctl" Type="VI" URL="../Action/电机控制/Motor Logic/所有测试电机转动逻辑.ctl"/>
			<Item Name="停止判断条件1.ctl" Type="VI" URL="../Action/电机控制/Motor Logic/停止判断条件1.ctl"/>
			<Item Name="自动调阀测试动作设置.ctl" Type="VI" URL="../Action/自动调阀测试动作设置.ctl"/>
		</Item>
